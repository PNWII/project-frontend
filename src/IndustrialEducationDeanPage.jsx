...
function IndustrialEducationDeanPage() {
  ...
  const fetchDocuments = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost/TestPHP-API2/backend/get-related-reportsIndustrialEducationDean.php",
        {
          method: "POST",
  ...
  useEffect(() => {
    ...
    if (!isLoggedIn || role !== "คณบดีคณะครุศาสตร์อุตสาหกรรม") {
  ...
  const handleSubmitReject = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost/TestPHP-API2/backend/RejectDocument-IndustrialEducationDean.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleSubmitApproval = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost/TestPHP-API2/backend/ApproveDocument-IndustrialEducationDean.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(payload),
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      ...
                      <Badge
                        bg={
                          doc.message ===
                          "ได้รับการอนุมัติจากคณบดีคณะครุศาสตร์อุตสาหกรรมแล้ว"
                            ? "success text-white"
                            : doc.message ===
                              "รอการพิจารณาจากคณบดีคณะครุศาสตร์อุตสาหกรรม"
                            ? "warning"
                            : doc.message ===
...
export default IndustrialEducationDeanPage;
