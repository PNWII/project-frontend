...
function NavbarChairpersonCurriculum() {
      ...
      <Container>
        ...
        <Navbar.Collapse id="navbar-nav">
          <Nav className="ms-auto navLinks">
            <Nav.Link href="/chairperson-curriculum" style={{ color: "white" }}>
              หน้าแรก
            </Nav.Link>
            <Nav.Link href="/chairperson-curriculum" style={{ color: "white" }}>
              อนุมัติเอกสารคำร้อง
            ...
            <Nav.Link
              href="/viewstudent-chairperson-curriculum"
              style={{ color: "white" }}
            >
              ข้อมูลบัณฑิตศึกษา
            </Nav.Link>
            <Nav.Link
              href="/aboutpagechairperson-curriculum"
              style={{ color: "white" }}
            >
              เกี่ยวกับเรา
            </Nav.Link>
            ...
            >
              <NavDropdown.Item
                href="/profilechairperson-curriculum"
                style={{ color: "black" }}
              >
                ข้อมูลส่วนตัว
              </NavDropdown.Item>
              <NavDropdown.Item
                href="/chairperson-curriculum"
                style={{ color: "black" }}
              >
                อนุมัติเอกสารคำร้อง
              </NavDropdown.Item>
...
export default NavbarChairpersonCurriculum;
