...
function NavbarGraduateOfficer() {
      ...
      <Container>
        ...
        <Navbar.Collapse id="navbar-nav">
          <Nav className="ms-auto navLinks">
            <Nav.Link href="/graduate-officer" style={{ color: "white" }}>
              หน้าแรก
            </Nav.Link>
            <Nav.Link href="/graduate-officer" style={{ color: "white" }}>
              อนุมัติเอกสารคำร้อง
            </Nav.Link>
            <Nav.Link href="/viewstudent-officer" style={{ color: "white" }}>
              ข้อมูลบัณฑิตศึกษา
            </Nav.Link>
            <Nav.Link
              href="/aboutpagegraduate-officer"
              style={{ color: "white" }}
            >
              เกี่ยวกับเรา
            </Nav.Link>
            ...
            >
              <NavDropdown.Item
                href="/profilegraduate-officer"
                style={{ color: "black" }}
              >
                ข้อมูลส่วนตัว
              </NavDropdown.Item>
              <NavDropdown.Item
                href="/graduate-officer"
                style={{ color: "black" }}
              >
                อนุมัติเอกสารคำร้อง
              </NavDropdown.Item>
...
export default NavbarGraduateOfficer;
