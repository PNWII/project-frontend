...
function NavbarTeacher() {
  ...
  return (
    <Navbar
      expand={expand}
      className="navbar"
      style={{ backgroundColor: "#7d3c98", color: "white" }} // Set color to white for text
    >
      <Container>
        <Navbar.Brand
        ...
        <Navbar.Collapse id="navbar-nav">
          <Nav className="ms-auto navLinks">
            <Nav.Link href="/teacherpage" style={{ color: "white" }}>
              หน้าแรก
            </Nav.Link>
            <Nav.Link href="/teacherpage" style={{ color: "white" }}>
              อนุมัติเอกสารคำร้อง
            </Nav.Link>
            <Nav.Link href="/viewstudentteacher" style={{ color: "white" }}>
              ข้อมูลบัณฑิตศึกษา
            </Nav.Link>
            <Nav.Link href="/aboutpageteacher" style={{ color: "white" }}>
              เกี่ยวกับเรา
            </Nav.Link>
            ...
            >
              ...
              <NavDropdown.Item href="/teacherpage" style={{ color: "black" }}>
                อนุมัติเอกสารคำร้อง
              </NavDropdown.Item>
              <NavDropdown.Divider />
              <NavDropdown.Item
