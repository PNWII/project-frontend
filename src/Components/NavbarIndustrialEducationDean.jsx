...
function NavbarIndustrialEducationDean() {
      ...
      <Container>
        ...
        <Navbar.Collapse id="navbar-nav">
          <Nav className="ms-auto navLinks">
            <Nav.Link
              href="/industrial-education-dean"
              style={{ color: "white" }}
            >
              หน้าแรก
            </Nav.Link>
            ...
            <Nav.Link
              href="/viewstudent-industrial-education-dean"
              style={{ color: "white" }}
            >
              ข้อมูลบัณฑิตศึกษา
            </Nav.Link>
            <Nav.Link
              href="/aboutpageindustrial-education-dean"
              style={{ color: "white" }}
            >
              เกี่ยวกับเรา
            </Nav.Link>
            ...
            >
              <NavDropdown.Item
                href="/profileindustrial-education-dean"
                style={{ color: "black" }}
              >
                ข้อมูลส่วนตัว
              </NavDropdown.Item>
...
export default NavbarIndustrialEducationDean;
