...
import "../Profile/ProfileGraduateOfficer.css";

function ProfileGraduateOfficer() {
  ...
  return (
    <>
      ...
      <div className="container mt-4">
        ...
        {teacherData ? (
          <div className="profile-card-graduateofficer mx-auto">
            <div className="profile-header-graduateofficer text-center">
              <h1>ข้อมูลบุคลากร</h1>
              <h3>
                คณะครุศาสตร์อุตสาหกรรม มหาวิทยาลัยราชมงคลอีสาน วิทยาเขตขอนแก่น
              </h3>
            </div>
            <div className="profile-body-graduateofficer">
              <h5
...
export default ProfileGraduateOfficer;
