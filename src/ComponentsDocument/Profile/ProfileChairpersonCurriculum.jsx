...
import "../Profile/ProfileChairpersonCurriculum.css";

function ProfileChairpersonCurriculum() {
  ...
  return (
    <>
      ...
      <div className="container mt-4">
        ...
        {teacherData ? (
          <div className="profile-card-chairpersoncurriculum mx-auto">
            <div className="profile-header-chairpersoncurriculum text-center">
              <h1>ข้อมูลบุคลากร</h1>
              <h3>
                คณะครุศาสตร์อุตสาหกรรม มหาวิทยาลัยราชมงคลอีสาน วิทยาเขตขอนแก่น
              </h3>
            </div>
            <div className="profile-body-chairpersoncurriculum">
              <h5
...
export default ProfileChairpersonCurriculum;
