...
import "../Profile/ProfileAcademicResearchAssociateDean.css";

function ProfileAcademicResearchAssociateDean() {
  ...
  return (
    <>
      ...
      <div className="container mt-4">
        ...
        {teacherData ? (
          <div className="profile-card-AcademicResearchAssociateDean mx-auto">
            <div className="profile-header-AcademicResearchAssociateDean text-center">
              <h1>ข้อมูลบุคลากร</h1>
              <h3>
                คณะครุศาสตร์อุตสาหกรรม มหาวิทยาลัยราชมงคลอีสาน วิทยาเขตขอนแก่น
              </h3>
            </div>
            <div className="profile-body-AcademicResearchAssociateDean">
              <h5
...
export default ProfileAcademicResearchAssociateDean;
